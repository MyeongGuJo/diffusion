...
class GINEConv(MessagePassing):
    ...
    def __init__(self, mlp, eps=0, train_eps=False, activation='softplus', **kwargs):
    ...
    def forward(self, x, edge_index, edge_attr=None, size=None):
        ...
        # Node and edge feature dimensionalities need to match.
        ...
        # propagate type: (x: OptPairTensor, edge_attr: OptTensor)
    ...
    def __repr__(self):
        return '{}(nn={})'.format(self.__class__.__name__, self.mlp)
...
class GINEncoder(nn.Module):
    def __init__(
        ...
        for i in range(num_convs):
            self.convs.append(GINEConv(MultiLayerPerceptron(
                hidden_dim,
